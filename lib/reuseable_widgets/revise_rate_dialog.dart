...
class ReviseRateDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async{
        Provider.of<ApiDataProvider>(context, listen: false).setcurrencySymbolForExchangeRateScreen('');
        return true;
      },
      child: Dialog(
        child: Container(
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: Provider.of<ApiDataProvider>(context, listen: true).currencySymbolForExchangeRateScreen==''? InputDecoration(
                      ...
                      prefixIcon: Padding(
                        padding:  EdgeInsets.only(left: 20.0,top: 15),
                        child: Text(Provider.of<ApiDataProvider>(context, listen: true).currencySymbolForExchangeRateScreen),
                      ),
                      hintText: 'rate',
                      helperStyle: TextStyle(color: blackColor),
                      isDense: true,
